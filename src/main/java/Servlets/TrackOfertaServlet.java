 ...
 * @author Ian Cardenas
 */
@WebServlet(name = "TrackOfertaServlet", urlPatterns = {"/TrackOfertaServlet"})
public class TrackOfertaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            controller.RegistrarTrackVerOferta(idOferta, idRubro, idConsumidor);
        } catch (ClassNotFoundException | SQLException ex) {
            Logger.getLogger(TrackOfertaServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
